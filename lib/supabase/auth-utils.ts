  ...
  try {
    ...
    if (inputType !== "email") {
      ...
      if (!profiles || profiles.length === 0) {
        ...
        console.log("📊 Resultado da busca sem formatação:", { profilesClean, error: profileErrorClean })
        ...
        email = profile.email
        console.log("✅ Email encontrado (busca sem formatação):", email, "para usuário:", profile.name)
      } else {
