...
interface FileUploadFieldProps {
  ...
  entityId?: string;
  entityType?: string;
  onUploadComplete?: (fileData: { filePath: string; publicUrl: string; document: any }) => void;
...
export function FileUploadField({
  ...
  return (
    <div className="space-y-2">
      ...
      {description && <p className="text-[1rem] text-muted-foreground">{description}</p>}
      ...
      {uploading && (
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-[1rem] text-muted-foreground">{progress}%</span>
          </div>
      ...
      {uploadedFile && (
        <div className="flex items-center justify-between p-2 border rounded-md bg-muted/50">
          <div className="flex items-center space-x-2 truncate">
            ...
            <span className="text-[1rem] truncate">{file?.name}</span>
          </div>
