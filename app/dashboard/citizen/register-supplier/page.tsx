                    ...
                    <div className="space-y-2">
                      {supplyLines.map((line, index) => (
                        <div
                          ...
                          <span className="text-[1rem]">{getSupplyLineLabel(line)}</span>
                          <Button
                            type="button"
                            variant="ghost"
                            size="sm"
              ...
              <div className="space-y-6">
                <div className="rounded-md border p-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      <p className="text-[1rem] font-medium text-muted-foreground">Razão Social</p>
                      <p className="text-[1rem]">{formData.companyName}</p>
                    </div>
                    {supplierType === "national" ? (
                      ...
                      <div>
                        ...
                        <p className="text-[1rem]">{formData.foreignRegistrationNumber}</p>
                      </div>
                    )}
                ...
                <div className="rounded-md border p-4">
                  ...
                  <div className="space-y-2">
                    {supplyLines.map((line, index) => (
                      <div key={index} className="rounded-md bg-gray-50 p-2 text-[1rem]">
                  ...
                  <div className="space-y-4">
                    {representatives.map((rep, index) => (
                      <div key={index} className="rounded-md bg-gray-50 p-3">
                        ...
                        <p className="text-[1rem]">CPF: {rep.cpf}</p>
                        <p className="text-[1rem]">E-mail: {rep.email}</p>
                      </div>
                    ))}
                  </div>
                </div>
