      ...
      <div className="grid gap-6 md:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-[1rem] font-medium">CPU</CardTitle>
            <Server className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">68%</div>
            <Progress value={68} className="h-2 mt-2" />
            <p className="text-[1rem] text-muted-foreground mt-2">+12% em relação à média</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-[1rem] font-medium">Memória</CardTitle>
            <HardDrive className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">72%</div>
            <Progress value={72} className="h-2 mt-2" />
            <p className="text-[1rem] text-muted-foreground mt-2">+8% em relação à média</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-[1rem] font-medium">Banco de Dados</CardTitle>
            <Database className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">45%</div>
            <Progress value={45} className="h-2 mt-2" />
            <p className="text-[1rem] text-muted-foreground mt-2">Normal</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-[1rem] font-medium">Latência</CardTitle>
            <Zap className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">125ms</div>
            <Progress value={25} className="h-2 mt-2" />
            <p className="text-[1rem] text-muted-foreground mt-2">-5ms em relação à média</p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              ...
              <CardFooter>
                <p className="text-[1rem] text-muted-foreground">Pico de 82% às 10:00</p>
              </CardFooter>
            </Card>
            ...
            <Card>
              ...
              <CardFooter>
                <p className="text-[1rem] text-muted-foreground">Pico de 78% às 10:00</p>
              </CardFooter>
            </Card>
          </div>
                  ...
                  <Alert
                    ...
                    <AlertTitle className="flex items-center gap-2">
                      {alert.type === "error"
                        ...
                        ? "Aviso"
                        : "Informação"}
                      <span className="text-[1rem] text-muted-foreground">{alert.time}</span>
                    </AlertTitle>
        ...
        <TabsContent value="services">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Status atual e tempo de atividade dos serviços do sistema
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <h4 className="text-[1rem] font-medium">Alerta de CPU</h4>
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <h4 className="text-[1rem] font-medium">Alerta de Memória</h4>
                      <p className="text-[1rem] text-muted-foreground">
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <h4 className="text-[1rem] font-medium">Alerta de Banco de Dados</h4>
                      <p className="text-[1rem] text-muted-foreground">
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <h4 className="text-[1rem] font-medium">Alerta de Disco</h4>
                      <p className="text-[1rem] text-muted-foreground">
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <h4 className="text-[1rem] font-medium">Alerta de Falha de Login</h4>
                      <p className="text-[1rem] text-muted-foreground">
                        Notificar quando houver mais de 5 falhas de login consecutivas para um
                        usuário
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
