    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Informações e benefícios para Microempresas e Empresas de Pequeno Porte
        </p>
      </div>
        ...
        <TabsContent value="benefits" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Conheça os benefícios garantidos pela Lei Complementar 123/2006
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[1rem] text-muted-foreground">
                    Em caso de empate, a ME/EPP tem preferência na contratação, podendo apresentar
                    nova proposta com valor inferior.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[1rem] text-muted-foreground">
                    Prazo de 5 dias úteis, prorrogáveis por igual período, para regularização fiscal
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[1rem] text-muted-foreground">
                    Possibilidade de exigência de subcontratação de ME/EPP em licitações de obras e
                    serviços.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[1rem] text-muted-foreground">
                    Cota de até 25% do objeto para contratação exclusiva de ME/EPP em aquisições de
                    bens divisíveis.
                  </p>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  É a preferência de contratação para as microempresas e empresas de pequeno porte
                  em caso de empate ficto, ou seja, quando as propostas apresentadas por ME/EPP
                  sejam iguais ou até 10% superiores à proposta mais bem classificada (5% na
                  modalidade pregão).
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-2 text-[1rem] text-muted-foreground">
                  <li>
                    A ME/EPP mais bem classificada poderá apresentar proposta de preço inferior
                    àquela considerada vencedora do certame.
                  </li>
                  <li>
                    Não ocorrendo a contratação da ME/EPP, serão convocadas as remanescentes que
                    porventura se enquadrem na situação de empate, na ordem classificatória, para o
                    exercício do mesmo direito.
                  </li>
                  <li>
                    No caso de equivalência dos valores apresentados pelas ME/EPP que se encontrem
                    nos intervalos estabelecidos, será realizado sorteio entre elas para que se
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-md border p-4">
                  <p className="text-[1rem]">
                    <strong>Cenário:</strong> Pregão Eletrônico para aquisição de materiais de
                    escritório
                  </p>
                  <div className="mt-2 space-y-2">
                    ...
                    <p className="text-[1rem]">
                      <strong>Empresa B (ME/EPP):</strong> R$ 10.400,00 (4% acima da melhor
                      proposta)
                    </p>
                    <p className="text-[1rem]">
                      <strong>Empresa C (ME/EPP):</strong> R$ 10.500,00 (5% acima da melhor
                      proposta)
                    </p>
                  </div>
                  <div className="mt-4">
                    <p className="text-[1rem]">
                      <strong>Resultado:</strong> As Empresas B e C têm direito ao desempate ficto
                      por estarem dentro do limite de 5% (pregão). A Empresa B, por estar melhor
                      classificada, terá a primeira oportunidade de apresentar nova proposta com
