      ...
      <div className="space-y-6">
        ...
        {certificate && (
          <Alert variant={certificate.status === "rejected" ? "destructive" : "default"}>
            ...
            <AlertDescription className="flex items-center justify-between">
              ...
              <span className="text-sm">Enviado em {new Date(certificate.created_at).toLocaleDateString("pt-BR")}</span>
            </AlertDescription>
          </Alert>
        )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Preencha os dados do seu certificado de ME/EPP para obter os benefícios da Lei Complementar 123/2006
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Deixe em branco se não houver data de validade</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
          ...
          <CardFooter className="flex justify-between border-t pt-6">
            <p className="text-sm text-muted-foreground">
              Conforme Lei Complementar 123/2006, a condição de ME/EPP deve ser comprovada para obtenção dos benefícios.
            </p>
          </CardFooter>
        </Card>
      </div>
