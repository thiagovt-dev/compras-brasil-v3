        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Escolha a forma de pagamento e complete sua assinatura</CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  ...
                                  maxLength={3}
                                  {...field}
                                  onChange={(e) => field.onChange(e.target.value.replace(/\D/g, "").substring(0, 3))}
                                />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                  ...
                  {paymentMethod === "pix" && (
                    <div className="rounded-md border p-4 text-center">
                      ...
                      <p className="mt-2 text-xs text-muted-foreground">O pagamento será confirmado automaticamente</p>
                      <div className="mt-4">
                  ...
                  {paymentMethod === "boleto" && (
                    <div className="rounded-md border p-4">
                      ...
                      <div className="mt-4">
                        <p className="text-sm">
                          <span className="font-medium">Valor:</span> {formatCurrency(plan?.price || 0)}
                        </p>
                        <p className="text-sm">
