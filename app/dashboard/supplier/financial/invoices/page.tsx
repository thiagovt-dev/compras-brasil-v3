      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Você precisa estar logado para visualizar suas faturas.
          </p>
        </div>
      </div>
    );
        ...
        <CardContent>
          {invoices && invoices.length > 0 ? (
            <div className="rounded-md border">
              <div className="grid grid-cols-12 border-b bg-muted px-4 py-3 text-[1rem] font-medium">
              ...
              <div className="divide-y">
                {invoices.map((invoice) => (
                  <div key={invoice.id} className="grid grid-cols-12 items-center px-4 py-3">
                    ...
                    <div className="col-span-2 text-[1rem]">
